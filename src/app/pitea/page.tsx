...
export const metadata: Metadata = {
  title: 'Umefog Piteå - Fasadfogning & Brandtätning | Professionell Fuktskydd',
  description: 'Umefog erbjuder professionell fasadfogning, brandtätning, ljudtätning och skydd mot värmeläckage i Piteå. Kontakta oss för offert!',
};
...
const faqItems = [
  {
    question: "Hur beställer jag arbetet hos Umefog i Piteå?",
    answer: "Fastighetsägare, byggentreprenörer eller industrier i Piteå och omnejd som har behov av fogning och tätning skickar in underlag till Umefog. Därefter väljer de upplägg beroende på behov och projektets omfattning. De kan välja ett fast pris där vi beräknar kostnader för material, arbete och övriga moment, eller ett löpande pris där kunden får ta del av en tydlig prislista."
  },
  {
  ...
  return (
    <section className="relative h-[75vh] min-h-[500px] flex items-center justify-center text-center text-white">
      <Image
        ...
        alt="Fasadfogning och brandtätning i Piteå - professionell fuktskydd och värmeisolering"
        fill
      ...
      <div className="relative z-10 max-w-4xl px-6">
        <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl font-bold leading-tight tracking-tight">
          Specialister på fogning och brandtätning i Piteå
        </h1>
        <p className="mt-6 text-lg md:text-xl text-white/95 max-w-3xl mx-auto leading-relaxed">
           Umefog är specialister på fasadfogning, brandtätning och ljudtätning i Piteå och Norrbotten. Vi erbjuder professionella tjänster inom fogtätning och passivt brandskydd för både nyproduktion och befintliga fastigheter i regionen.
        </p>
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg md:text-xl text-slate-600 leading-relaxed">
            Vi arbetar i hela Piteåsområdet med allt från fasadfogning till brandtätning. Med rätt material och lång erfarenhet skapar vi hållbara lösningar som skyddar fastigheter mot fukt, värmeläckage, brand och ljud.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-20 items-center">
          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-8 text-lg text-slate-600 space-y-5 leading-relaxed">
              ...
              <p>För Umefog är långsiktiga kundrelationer en självklar del av verksamheten. Genom tydlig kommunikation, hög yrkesskicklighet och ett personligt bemötande strävar vi efter att leverera arbeten med hög kvalitet, något som uppskattas av våra kunder i Piteå och övriga delar av norra Sverige.</p>
            </div>
        ...
        <section id="kontakt" className="py-20 md:py-28 bg-white">
            <div className="container grid md:grid-cols-2 gap-16 items-start">
                <div>
                    ...
                    <p className="mt-6 text-lg md:text-xl text-slate-600 leading-relaxed">
                        Har du frågor eller vill du ha en offert för arbete i Piteå? Kontakta oss så återkommer vi så snart som möjligt.
                    </p>
...
export default function PiteåPage() {
  return (
